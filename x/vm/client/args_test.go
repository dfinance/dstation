...
func TestVMClient_NewAddressScriptArg(t *testing.T) {
	t.Parallel()
...
func TestVMClient_NewU8ScriptArg(t *testing.T) {
	t.Parallel()
...
func TestVMClient_NewU64ScriptArg(t *testing.T) {
	t.Parallel()
...
func TestVMClient_NewU128ScriptArg(t *testing.T) {
	t.Parallel()
...
func TestVMClient_NewBoolScriptArg(t *testing.T) {
	t.Parallel()
...
func TestVMClient_NewVectorScriptArg(t *testing.T) {
	t.Parallel()
